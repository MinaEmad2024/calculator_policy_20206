...
export default function Parameters({selectedOption} : ParametersProps) {
  ...
  return (
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 gap-4 w-full p-4">
                  ...
                  <Card title="1st CoIns" parameter={selectedOption?.coins?? "0"} sign="%"/>
                  <Card title="2nd CoIns " parameter={selectedOption?.coins2?? "0"} sign="%"/>
                  <Card title="3rd CoIns" parameter={selectedOption?.coins3?? "0"} sign="%"/>
